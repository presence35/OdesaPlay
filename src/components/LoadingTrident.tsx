export default function LoadingTrident({
  text = 'Loading...',
  className = '',
  size = 200,
}: {
  ...
  return (
    <div className={`flex flex-col items-center justify-center py-20 ${className}`}>
      <svg width={size} height={size * 230.5 / 165} viewBox="-82.5 0 165 230.5">
        <defs>
